...
Revision ID: cc718c38d7e2
Revises: 
Create Date: 2019-06-17 23:44:20.465444
...
def upgrade():
    ...
    sa.Column('describe', sa.String(length=512), nullable=False, comment='部门描述'),
    ...
    sa.Column('mobile', sa.String(length=64), nullable=True, comment='手机'),
